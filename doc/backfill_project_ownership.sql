...
insert into redcap_entity_project_ownership (created, updated, pid, username, email, firstname, lastname)
  ...
  from redcap_projects as rcp left join redcap_entity_project_ownership as rcpo on (rcp.project_id = rcpo.pid)
...
insert into redcap_entity_project_ownership (created, updated, pid, username, email, firstname, lastname)
    ...
    from redcap_projects as rcp
      ...
      left join redcap_entity_project_ownership as rcpo on (rcp.project_id = rcpo.pid)
...
update redcap_entity_project_ownership set
...
firstname= "Taryn",
lastname= "Stoffs"
where redcap_entity_project_ownership.username = "swehmeyer";
...
firstname= "Corinne",
lastname= "Holman"
where redcap_entity_project_ownership.username = "cabernat";
...
update redcap_entity_project_ownership as rcpo
